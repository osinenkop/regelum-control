...
controllers. A detailed documentation is available
[here](https://aidynamicaction.github.io/rcognita/).
...
+==================+========+==========================================+
| `control_mode`   | > | st | > | Controller mode                      |
|                  | ring   |                                          |
+------------------+--------+------------------------------------------+
...
|                  |        | estimated online                         |
+------------------+--------+------------------------------------------+
| `Nactor`         | intege | Horizon length (in steps) for predictive |
|                  | r      | controllers                              |
+------------------+--------+------------------------------------------+
| `running_obj_str | | stri | | Structure of running objective         |
| uct`             | ng     |   function                               |
+------------------+--------+------------------------------------------+
| `Ncritic`        | intege | Critic stack size (number of TDs)        |
|                  | r      |                                          |
+------------------+--------+------------------------------------------+
...
+------------------+--------+------------------------------------------+
| `save_trajectory | binary | Flag to store trajectory during the      |
