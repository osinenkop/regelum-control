...
class ComplementedConfig:
    """A config object, generated by ``regelum``'s config pipeline."""
...
class ComplementedConfigDict(ComplementedConfig):
    """A config object, generated by ``regelum``'s config pipeline that corresponds to a complemented version of `DictConfig` from omegaconf."""
