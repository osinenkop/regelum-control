...
* [Vanilla Policy Gradient](../tex/vpg.md)
* [Proximal policy optimization](../tex/ppo.md)
* [Model-predictive control](../tex/mpc.md)
* [Deep deterministic policy gradient](../tex/ddpg.md)
